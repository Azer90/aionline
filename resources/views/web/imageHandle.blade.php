    ...
    <div>
        <div class="main_right">
            ...
            <div class="item_dis">
                ...
                <span>对浓雾天气下拍摄，导致细节无法辨认的图像进行去雾处理，还原更清晰真实的图像。可应用于视频监控抓拍图处理等。</span>
            </div>
            <div class="item_dis">
                <div>
                    <img src="images/icons_07.jpg" />
                ...
                <span>可通过【本地上传】将需要去雾的图片上传，等待智能在线AI系统处理后，即可【点击下载】。</span>
            </div>
            <div class="tiujian">
                <div class="t_top">
                    <div>
        ...
        <div class="main_right hide">
            ...
            <div class="item_dis">
                ...
                <span>将图像在长宽方向各放大两倍，保持图像质量无损。可应用于视频监控抓拍图处理、彩印照片美化处理等。</span>
            </div>
            <div class="item_dis">
                <div>
                    <img src="images/icons_07.jpg" />
                ...
                <span>可通过【本地上传】将需要无损放大的图片上传，等待智能在线AI系统处理后，即可【点击下载】。</span>
            </div>
            <div class="tiujian">
                <div class="t_top">
                    <div>
        ...
        <div class="main_right hide">
            ...
            <div class="item_dis">
                ...
                <span>智能识别黑白图像内容并填充色彩，使黑白图像变得鲜活。可应用于老照片上色等。</span>
            </div>
            <div class="item_dis">
                <div>
                    <img src="images/icons_07.jpg" />
                ...
                <span>可通过【本地上传】将需要上色的黑白图片上传，等待智能在线AI系统处理后，即可【点击下载】。</span>
            </div>
            <div class="tiujian">
                <div class="t_top">
                    <div>
        ...
        {{--</div>--}}
            ...
            <span>自动识别过度拉伸的图像，将图像内容恢复成正常比例。可应用于对视频截图、网络图片</span>
        </div>
        <div class="item_dis">
            <div>
                <img src="images/icons_07.jpg" />
            ...
            <span>可通过【本地上传】将需要拉伸修复的图片上传，等待智能在线AI系统处理后，即可【点击下载】。</span>
        </div>
        <div class="tiujian">
            <div class="t_top">
                <div>
